"""Behance platform module — design portfolio discovery."""
...
class BehancePlatform(BasePlatform):
    """Behance platform for design portfolio discovery."""
    ...
    async def check_username(self, username: str) -> bool | None:
        """Check if a Behance username exists."""
    ...
    async def search_name(
        ...
        """Search for Behance users — returns empty (no public search API)."""
        return []

    async def scrape_profile(self, url: str) -> ProfileData | None:
        """Scrape a Behance profile page."""
    ...
    def _parse_profile(self, html_text: str, username: str) -> ProfileData | None:
        """Parse Behance profile from HTML/meta tags."""
    ...
    def _extract_username(url: str) -> str | None:
        """Extract Behance username from a URL."""
