"""SoundCloud platform module — audio/music profile discovery."""
...
class SoundCloudPlatform(BasePlatform):
    """SoundCloud platform for audio/music profile discovery."""
    ...
    async def check_username(self, username: str) -> bool | None:
        """Check if a SoundCloud username exists."""
    ...
    async def search_name(
        ...
        """Search for SoundCloud users — returns empty (no public search API)."""
        return []

    async def scrape_profile(self, url: str) -> ProfileData | None:
        """Scrape a SoundCloud profile page."""
    ...
    def _parse_profile(self, html_text: str, username: str) -> ProfileData | None:
        """Parse SoundCloud profile from HTML/meta tags."""
    ...
    def _extract_username(url: str) -> str | None:
        """Extract SoundCloud username from a URL."""
