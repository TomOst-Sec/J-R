"""Kaggle platform module — data science profile discovery."""
...
class KagglePlatform(BasePlatform):
    """Kaggle platform for data science profile discovery."""
    ...
    async def check_username(self, username: str) -> bool | None:
        """Check if a Kaggle username exists."""
    ...
    async def search_name(
        ...
        """Search for Kaggle users — returns empty (no public search API)."""
        return []

    async def scrape_profile(self, url: str) -> ProfileData | None:
        """Scrape a Kaggle profile page."""
    ...
    def _parse_profile(self, html_text: str, username: str) -> ProfileData | None:
        """Parse Kaggle profile from HTML/meta tags."""
    ...
    def _extract_username(url: str) -> str | None:
        """Extract Kaggle username from a URL."""
